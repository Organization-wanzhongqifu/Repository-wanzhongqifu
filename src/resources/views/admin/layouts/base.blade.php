...
<head>
 ...
 <!-- Fc_admin style -->
 <link rel="stylesheet" href="{{ asset('static/admin/plugins/lightbox2/css/lightbox.min.css') }}">
 <link rel="stylesheet" href="{{ asset('static/admin/plugins/bootstrap-select/css/bootstrap-select.min.css') }}">
 <link rel="stylesheet" href="{{ asset('static/admin/css/fc_admin.css?v=0.1.2') }}">
