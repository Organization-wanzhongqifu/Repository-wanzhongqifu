        ...
        $(function(){
            ...
            dataTable = $("#dataTable").DataTable({
                ...
                columns: [
                    ...
                    {data: 'service_province', name: 'service_province', orderable: false, render: function (data, type, row) {
                            ...
                            return row['service_province'] + city + row['service_district'];
                        }},
            ...
            $('body').on('click', '.delete', function () {
                ...
                layer.confirm('确定删除？', {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '/adminApi/approvals/' + id + '/delete'
                    }).done(function (data) {
            ...
            $('#excel').on('change', function (e) {
                ...
                $.ajax({
                    url: "{{ url('adminApi/approvals/import') }}",
                    type: 'POST',
                    cache: false,
                    data: formData,
                    processData: false,
                ...
                layer.open({
                    ...
                    ,yes: function (index, layero) {
                        ...
                        if (arrive_time && leave_time) {
                            layer.msg('导出成功');
                            layer.close(index);
                            window.location.href = '{{ url('adminApi/approvals/export') }}' + '?begin_time='+arrive_time+'&end_time='+leave_time;
                        } else {
    ...
    <div class="box">
        <div class="box-body table-responsive">
            <table id="dataTable" class="table table-bordered table-striped">
                ...
                <tr>
                    <th colspan="10">
                        <a href="{{ url('admin/approvals/create') }}" class='btn btn-success btn-sm'>新增</a>
