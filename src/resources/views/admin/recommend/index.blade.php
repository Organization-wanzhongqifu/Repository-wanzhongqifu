        ...
        $(function(){
            ...
            $('body').on('click', '.delete', function () {
                ...
                layer.confirm('确定删除？', {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '/adminApi/recommend/' + id + '/delete'
                    }).done(function (data) {
    ...
    <div class="box">
        <div class="box-body table-responsive">
            <table id="dataTable" class="table table-bordered table-striped">
                ...
                <tr>
                    <th colspan="10">
                        <a href="{{ url('admin/recommend/create') }}" class='btn btn-success btn-sm'>新增</a>
                    </th>
                </tr>
                <tr>
                    <th>序号</th>
