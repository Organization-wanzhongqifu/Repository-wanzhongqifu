...
@section('indexBanner')
    <div class="about-banner" style="background-image: url({{ asset('web/pic/banner-about.jpg')}});"></div>
@endsection
...
@section('content')
            ...
            <div class="about-intro">
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        ...
                        <p>目前服务范围包含北京、上海、广州、深圳 江苏、浙江、四川、山东、黑龙江、福建等十多个城市，平台拥有超过1800家专业财税服务团队，每月为全国超过60万中小微企业 提供记账报税服务，为过百万创业者提供公 司注册、税务代办等一体化财税服务。</p>
                    </div>
                    <div class="col-xs-4">
                        <i class="icon icon15"></i>
                        <p>万众企服依托“智能财税”，以标准化、智能化、规模化为目标，凭借模式创新、技术驱动、以用户为中心等核心优势，在提升行业效率、解决用户痛点的方向持续努力，致力于为中小企业提供更专业、更深度的智能 财税服务。</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="cell has-bg no-padding">
        <div class="container">
            <img src="{{ asset('web/pic/advantage02.png') }}" class="about-bg"> </div>
    </div>
    <div class="cell">
        <div class="container">
            <h3 class="cell-title" id="contact">联系我们</h3>
            <a href="" target="_blank">
                <img src="{{ asset('web/images/map.png') }}" alt="" class="map"> </a>
            <address>总部地址：北京市东城区银河SOHO D座11层51110</address>
            <div class="row">
                <div class="col-xs-3">
                    <div class="add-item">
    ...
    <div class="about-backgroud" style="background-image: url({{ asset('web/pic/bg04.jpg') }});"></div>
@endsection